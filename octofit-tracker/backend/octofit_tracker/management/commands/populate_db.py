...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        Activity.objects.create(name='Swimming', user_email='spiderman@marvel.com')
        Activity.objects.create(name='Cycling', user_email='batman@dc.com')
        Activity.objects.create(name='Yoga', user_email='wonderwoman@dc.com')
